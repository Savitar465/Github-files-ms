# Guía de Contribuciones - Github-files-ms

Gracias por interés en contribuir a `Github-files-ms`. Este documento define el proceso, estándares y expectativas.
...
### 1. Fork y clona
```bash
git clone https://github.com/<tu-usuario>/Github-files-ms.git
cd Github-files-ms
git remote add upstream https://github.com/<org>/Github-files-ms.git
```
...
- Slack `#Github-files-ms-dev` para discusiones
...
**Gracias por contribuir a mejorar Github-files-ms** 🚀
